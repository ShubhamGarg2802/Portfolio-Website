...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_5rkd3ym', 'template_m8lz10q', formRef.current, 'fAyNbsDZ3P6e5z9xK')
            .then((result) => {
                setSuccess(true)
            }, (error) => {
                setError(true)
            ...
            <motion.div ref={ref} className="contact" variants={variants} initial="initial" whileInView="animate">
                <motion.div className="textContainer" variants={variants}>
                    ...
                    <motion.div className="item" variants={variants}>
                        <h2>Mail</h2>
                        <span>gargshubham2802@gmail.com</span>
                    </motion.div>
                    <motion.div className="item" variants={variants}>
                        <h2>Address</h2>
                        <span>Street Number 2, Srinagar, Delhi-110034</span>
                    </motion.div>
                    <motion.div className="item" variants={variants}>
                        <h2>Phone</h2>
                        <span>+91 9891255345</span>
                    </motion.div>
                </motion.div>
